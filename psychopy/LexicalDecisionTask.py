...
expName = 'LexicalDecisionTask'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Public\\Documents\\Hilgard\\Verbal Tasks 3\\psychopy\\LexicalDecisionTask.py',
...
text = visual.TextStim(win=win, name='text',
    text='In this task, your job is to identify whether the text displayed on the screen is a word or a nonword.\n\nPress a button to continue.',
    font='Arial',
...
if random() > 0.5:
    expInfo['respMapping'] = 'wordleft'
    wordResp = 'f'
    nonwordResp = 'j'
else:
    expInfo['respMapping'] = 'wordright'
    wordResp = 'j'
    nonwordResp = 'f'

thisExp.addData("respMapping", expInfo['respMapping'])

introtext = "If the text is a real word, press the %s key.\n\nIf the text is not a real word, press the %s key.\n\nPress a key to begin." %(wordResp, nonwordResp)
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='default text',
    font='Arial',
    pos=[0, 0], height=0.1, wrapWidth=50, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=0.0);
...
textBye = visual.TextStim(win=win, name='textBye',
    text='You have completed this part of the experiment.',
    font='Arial',
    pos=[0, 0], height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
instr1Components = [text, key_resp_4]
...
# update component parameters for each repeat
text_2.setText(introtext)
key_resp_3.keys = []
key_resp_3.rt = []
# keep track of which components have finished
instr2Components = [text_2, key_resp_3]
...
trials = data.TrialHandler(nReps=7, method='random', 
    ...
    trialList=data.importConditions('Bartholow_Heinz_2006.xlsx'),
...
for thisTrial in trials:
    ...
    # update component parameters for each repeat
    TargetText.setText(word)
    key_resp_2.keys = []
    key_resp_2.rt = []
    # keep track of which components have finished
    trialComponents = [ISI, TargetText, key_resp_2, fixation]
    ...
    while continueRoutine:
        ...
        # *TargetText* updates
        if TargetText.status == NOT_STARTED and tThisFlip >= 0.25-frameTolerance:
            # keep track of start time/frame for later
        ...
        if fixation.status == STARTED:
            ...
            if tThisFlipGlobal > fixation.tStartRefresh + .25-frameTolerance:
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if textBye.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > textBye.tStartRefresh + 5.0-frameTolerance:
            # keep track of stop time/frame for later
            textBye.tStop = t  # not accounting for scr refresh
            textBye.frameNStop = frameN  # exact frame index
            win.timeOnFlip(textBye, 'tStopRefresh')  # time at next scr refresh
            textBye.setAutoDraw(False)
